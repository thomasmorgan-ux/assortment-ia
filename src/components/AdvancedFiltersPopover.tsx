              ...
              <li key={row.id} role="none">
                ...
                >
                  ...
                  <span className="flex min-w-0 flex-1 flex-col gap-0.5">
                    <span className="truncate font-['Inter',sans-serif] text-xs font-bold uppercase leading-snug tracking-wide text-[#101828]">
                      {row.primary}
                    </span>
                    <span className="truncate font-['Inter',sans-serif] text-[11px] font-normal leading-snug text-[#6A7282]">
                      {row.secondary}
                    </span>
                  </span>
                </button>
